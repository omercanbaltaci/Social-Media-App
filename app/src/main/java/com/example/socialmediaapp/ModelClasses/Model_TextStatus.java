...
public class Model_TextStatus {
    ...
    public Model_TextStatus(String useremail, String currentdatetime, String status, String profileurl, int nooflove, int noofhaha, int noofsad, int noofcomments) {
